...
export const textInit: Text[] = [
  ...
  [KEYS.CREATED_BY, 'Created by', 'Создали'],
  [KEYS.DOCUMENTATION, 'Documentation', 'Документация'],
  [KEYS.SCHEMA_TYPES, 'All Schema Types', 'Все типы схемы'],
  [KEYS.FIELDS, 'Fields', 'Поля'],
  [KEYS.VARIABLES, 'Variables', 'Переменные'],
  [KEYS.HEADERS, 'Headers', 'Заголовки'],
  [KEYS.QUERY_PLACEHOLDER, 'Type your query here...', 'Введите ваш запрос здесь...'],
  [KEYS.VARIABLES_PLACEHOLDER, 'Type your variables here...', 'Введите ваши переменные здесь...'],
  [KEYS.HEADERS_PLACEHOLDER, 'Type your headers here...', 'Введите ваши заголовки здесь...'],
  [KEYS.ENDPOINT_PLACEHOLDER, 'Type your endpoint here...', 'Введите ваш конечный пункт здесь...'],
  [KEYS.BACK_HOME, 'Back to home', 'Назад на главную'],
  [
    KEYS.NOT_FOUND,
